...
Client.prototype.parse = function (xml, cb) {
  ...
  parser.on('end', function () {
    ...
    if (result && result.eveapi && result.eveapi.error) {
      ...
      if (result.eveapi.currentTime) result.eveapi.error.currentTime = result.eveapi.currentTime
      if (result.eveapi.cachedUntil) result.eveapi.error.cachedUntil = result.eveapi.cachedUntil
